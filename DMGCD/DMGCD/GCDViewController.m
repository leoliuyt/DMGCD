...
- (void)dispatch_source_4
{
    ...
    dispatch_source_set_event_handler(source, ^{
        ...
        CGFloat progress = (CGFloat)totalComplete / (kMaxIndex * kPerValue);
    ...
    dispatch_queue_t globalQ = dispatch_queue_create("serial", DISPATCH_QUEUE_SERIAL);
